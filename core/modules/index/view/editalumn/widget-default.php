...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="name" value="<?php echo $alumn->name; ?>" required class="form-control" id="name" placeholder="Nombres">
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="dni"  class="form-control" value="<?php echo $alumn->dni; ?>" id="name" placeholder="DNI">
    </div>
  </div>
...
<h2>Datos del Tutor</h2>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="c1_fullname" value="<?php echo $alumn->c1_fullname; ?>" class="form-control" id="nombreTutor" placeholder="Apellidos y Nombres">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Domicilio*</label>
