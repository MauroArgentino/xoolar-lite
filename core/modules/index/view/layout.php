    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Xoolar Lite <sup><small><span class="label label-success">v1.1</span></small></sup> </a>
        </div>
...
if(Session::getUID()!=""){
  ...
  $user = $u->name." ".$u->lastname;
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="index.php?view=configuration">Configuración</a></li>
