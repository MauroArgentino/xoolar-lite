...
<br>
		...
		if(count($teams)>0){
			...
			foreach($teams as $team){
				...
				<td style="width:130px;"><a href="index.php?view=editteam&id=<?php echo $team->id;?>" class="btn btn-warning glyphicon glyphicon-edit"></a> <a href="index.php?action=delteam&id=<?php echo $team->id;?>" class="btn btn-danger glyphicon glyphicon-trash"></a></td>
				</tr>
				<?php
