...
<br>
		...
		if(count($teams)>0){
			...
			foreach($teams as $team){
				...
				<td class="align-middle"><a href="./?view=team&id=<?php echo $team->id;?>"><?php echo $team->name." ".$team->lastname; ?></a></td>				
				<td style="width:130px;"><a href="index.php?view=editteam&id=<?php echo $team->id;?>" class="btn btn-warning glyphicon glyphicon-edit"></a> <a href="index.php?view=delteam&id=<?php echo $team->id;?>" class="btn btn-danger glyphicon glyphicon-trash"></a></td>
				</tr>
				<?php
